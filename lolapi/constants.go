...
const ITEMS_JSON = `http://ddragon.leagueoflegends.com/cdn/6.3.1/data/en_US/item.json?`
const ITEMS_BY_ID = `https://global.api.pvp.net/api/lol/static-data/na/v1.2/item/%v?itemData=all&`
const ITEM_PICTURE = `http://ddragon.leagueoflegends.com/cdn/6.3.1/img/item/`
...
const CHAMPION_PICTURE = `http://ddragon.leagueoflegends.com/cdn/6.3.1/img/champion/`
